...
public class Nodo implements Comparable {
	...
	public static int dame_mejor(int datos_pasteleros[][], int tipo_pastel,
			int n) {
	...
	public void setCota() {
		...
		// Calculamos lo que queda por asignar considerando algo muy muy bueno
		// aunque sea imposible. Por ejemplo, asignar el mejor de los beneficios
		// que la tabla
		...
		for (int i = etapa + 1; i <= n; i++) {
			// Dame el mejor pastelero para ese tipo de pastel, aunque este
			// ocupado
			int mejor_para_ese_pastel = dame_mejor(datos_pasteleros,
					pasteles[i], n);
			beneficio = beneficio
					+ datos_pasteleros[mejor_para_ese_pastel][pasteles[i]];
		}
